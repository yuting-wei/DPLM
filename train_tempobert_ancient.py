...
import hf_utils
import torch
from tempobert.modeling_tempobert import TempoBertForMaskedLM
...
class ModelArguments:
    ...
    num_time_layers: Optional[int] = field(
        default=9,
        metadata={"help": "Number of time layers in the Transformer encoder."},
    )
    ...
    time_embedding_type: Optional[str] = field(
        ...
        metadata={
            "help": "Time embedding type. Possible values: `temporal_attention`."
        },
    )
...
class DataTrainingArguments:
    ...
    train_path: Optional[str] = field(
        default='datasets/ancient_3', metadata={"help": "The input training data file or directory."}
    )
